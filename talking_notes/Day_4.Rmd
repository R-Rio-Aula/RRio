...
1.  Install the package `rebird` using the command `install.packages("rebird")`

2.  Load the `rebird` package using `library`

3.  Obtain a dataset containing bird sitings in Rio de Janeiro, Brasil using the command `bird_data <- ebirdregion("BR-RJ")`