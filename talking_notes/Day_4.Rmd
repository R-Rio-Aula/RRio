...
1.  Clean up some data

2.  Write a function to perform a calculation on some data

3.  Use `dplyr` to apply the function over the data frame

4.  Create a plot

5.  Push the script to your Github repository