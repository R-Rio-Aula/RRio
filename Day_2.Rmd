...
#### Create a new column using data from the other columns

You can repeat a process on every row in a data frame.
...
Do a gapminder project that somewhat resembles something you might actually want to do

## From plots to functions -> Project to show why you might want to have functions

e.g. what if you want to repeat an analysis on multiple data sets? coefficient of variation
