...
write.table(x = brazil, file = "clean_data/brazil_data.csv", sep = ",")

write.table(x = brazil,
            file = "clean_data/brazil_data.csv",
            sep = ",",
            row.names = FALSE,
            quote = FALSE)

write.csv(x = brazil, file = "clean_data/brazil_data2.csv")

write.table(x = brazil,
            file = "clean_data/brazil_data_tabbed.csv",
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)

write.table(x = brazil,
            file = "clean_data/brazil_data_semicolon.csv",
            sep = ";",
            row.names = FALSE,
            quote = FALSE)

brazil2 <- read.table("clean_data/brazil_data_tabbed.csv", sep = "\t", header = TRUE)
head(brazil2)
...
write.table(x = since_1990,
            file = "clean_data/gapminder_since_1990.csv",
            sep = "\t",
            row.names = FALSE,
            quote = FALSE)
